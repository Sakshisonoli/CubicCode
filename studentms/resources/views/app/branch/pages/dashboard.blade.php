                ...
                <div class="col-xl-12 wid-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Leads <i class="bi bi-circle-fill identity-icon3"></i> Vs &nbsp;
