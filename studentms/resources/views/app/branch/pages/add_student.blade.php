                        ...
                        @if ($batches->count() > 0)
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" action="{{ route('branch_store_student') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" name="name" class="form-control"
                                                            id="name" placeholder="Enter student full name" required>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="email" name="email" class="form-control"
                                                            id="email" placeholder="Enter student email id" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="phone">Student Mobile
                                                        Number
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" name="phone" class="form-control"
                                                            id="phone" placeholder="Enter student mobile number"
                                                            required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" name="address" class="form-control"
                                                            id="address" placeholder="Enter student valid address">
                                                        <div class="invalid-feedback">
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="admission_date">Admission
                                                        Date
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="default-select wide form-control" name="batch_id"
                                                            id="batch_id" required>
                                                ...
                                                <div>
                                                    <p class="text-danger"> * Please create batch first and then add
                                                        students
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="payment_mode">Payment
                                                        Options
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3 mb-0">
                                                            <div class="form-check custom-checkbox form-check-inline">
                                                                <input type="radio" class="form-check-input"
                                                                    id="lumpsum" name="payment_mode" value="Lumpsum">
                                                                <label class="form-check-label"
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="course_amount">Course
                                                        Amount
                                                    </label>
                                                    <div class="col-lg-6">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="payment_status">Payment
                                                        Staus
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                        ...
                                        <div class="installment-field">
                                            <div class="row pt-4">
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label"
                                                            for="total_installments">No. Of
                                                            Installments
                                                        </label>
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control"
                                                                name="total_installments" id="total_installments">
                                                                <option selected disabled>Please select Installments
                                                                </option>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label" for="amount_paid">Paid
                                                            Amount
                                                        </label>
                                                        <div class="col-lg-6">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-lg-2 col-form-label" for="note">Note
                                            </label>
                                            <div class="col-lg-10">
                        ...
                        @else
                            <div class="">
                                <div class="card-body text-center">
                                    <h1>
                                        Batch creation is required before adding students. Please create a batch now. <a
                                            href="{{ route('branch_create_batch') }}"> <u>Create Batch</u> </a>
                                    </h1>
                                </div>
                            </div>
