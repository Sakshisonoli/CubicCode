        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                @if (auth()->user()->admin_role === 'super')
                                    <button type="button" class="modal-btn btn btn-primary btn-sm  ms-2 "
                ...
                <div class="modal-dialog modal-dialog-center">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('update_student_batch') }}" method="POST">
                                @csrf
                                <div class="row mb-4">
                                    <div class="col-xl-12">
            ...
            <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel3"
                ...
                <div class="modal-dialog modal-dialog-center">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel1">Edit Batch Details
                            </h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('update_batch_details', ['id' => $details->id]) }}" method="POST">
                                @csrf
                                <div class="row mb-4">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <label class="form-label mt-3">Batch Name</label>
                                                <div class="input-group">
                                                    <input type="text" name="batch_name" class="form-control"
                                                        id="batch_name" value="{{ $details->batch_name }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <label class="form-label mt-3">Batch Timing</label>
                                                <div class="input-group">
                                                    <input type="text" name="batch_time" class="form-control"
                                                        id="batch_time" value="{{ $details->batch_time }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <label class="form-label mt-3">Faculty</label>
                                                <div class="input-group">
                                                    <input type="number" name="faculty_id" class="form-control"
                                                        id="faculty_id" value="{{ $details->faculty_id }}">
                                                </div>
                                            </div>
                                        </div>
