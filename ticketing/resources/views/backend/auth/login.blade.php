                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <div class="d-flex justify-content-center">
                                            <a href="/">
                                                <img width="100px" src="{{ asset('/queues-logo.png') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    ...
                                    <form action="{{ route('authentication') }}" method="POST" class="row g-3">
                                        @csrf
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0"><a href="{{ route('forgot.password') }}">Forgot
                                                    Password</a>
                                            </p>
                                        </div>
