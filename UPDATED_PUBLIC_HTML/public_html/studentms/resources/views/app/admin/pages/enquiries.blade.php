                                ...
                                <div class="tbl-caption">
                                    <div>
                                        ...
                                        @if (auth()->user()->admin_role === 'super')
                                            <a class="btn btn-success btn-sm" href="{{route('export_leads')}}">
                                                Export All Leads
                                            </a>
                                        @endif
                                        ...
                                        data-bs-target="#exampleModal5">
                                         ...
                                         {{-- Modal view details --}}
                                        <div class="modal fade" id="exampleModal5" tabindex="-1" aria-labelledby="exampleModalLabel1"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('import_leads') }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <button type="submit" class="btn btn-primary btn-sm text-center w-100">Import</button>
                                                            </form>
                                                        </div>
