                ...
                <div class="col-xl-12">
                    ...
                    <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('course_details', ['id' => $studentData->id]) }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-center">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="exampleModalLabel1">Edit Payment Details</h1>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form action="{{route('update_payment_details', ['id' => $payment->id])}}" method="POST">
                                                                        @csrf
                                                                        <div class="row mb-4">
                                                                            <div class="col-xl-12">

                                                                                <label class="form-label mt-3">Payment date<span class="text-danger">*</span></label>
                                                                                <input class="form-control" type="date" id="installment_date" name="installment_date" value="{{$payment->installment_date}}"
                                                                                    required>

                                                                                <label class="form-label mt-3">Paid Amount <span class="text-danger">*</span></label>
                                                                                ...
                                                                                <input class="form-control" type="text" id="amount_due" name="amount_due" value="{{$payment->amount_due}}">
                                                                                    ...
                                                                                    <div class="col-xl-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input type="date" name="next_installment_date" class="form-control"
                                                                                                id="next_installment_date" value="{{$payment->next_installment_date}}">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input type="text" name="next_installment_amount" class="form-control"
                                                                                                id="next_installment_amount" value="{{$payment->next_installment_amount}}">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('installment_payment', ['id' => $dueAmountData->student_id]) }}" method="POST">
                        @csrf
                        <div class="row mb-4">
                            <div class="col-xl-12">
