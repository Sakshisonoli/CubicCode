                                ...
                                <div class="profile-personal-info">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500">Lead ID <span class="pull-end">:</span>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500">Lead Date <span class="pull-end">:</span>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-9 col-7">
                                            <span class="text-danger">
                                                {{ \Carbon\Carbon::createFromFormat('Y-d-m', $details->followup_date)->format('F j, Y') }}
                                            </span>
                                        </div>
                                    </div>
