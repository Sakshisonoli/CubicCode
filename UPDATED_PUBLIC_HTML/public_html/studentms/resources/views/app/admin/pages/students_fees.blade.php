                                            ...
                                            @foreach ($branches as $branch)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <b>₹</b>
                                                            {{ number_format($branch->fees->sum('course_amount')) }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span>
                                                            <b>₹</b> {{ number_format($branch->fees->sum('amount_paid')) }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <b>₹</b>
                                                            {{ number_format($branch->fees->sum('course_amount') - $branch->fees->sum('amount_paid')) }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <a href="{{ route('branch_all_students_fees', ['id' => $branch->id]) }}"
                                                                class="btn light btn-success btn-xxs me-2"><i
                                                                    class="fa fa-eye"></i> Students </a>


                                                            {{-- <a href="{{ route('fees_paid_students', ['id' => $branch->id]) }}"
                                                                class="btn btn-success shadow btn-xs sharp me-2"><i
                                                                    class="fa fa-rupee"></i></a>

                                                            <a href="{{ route('fees_pending_students', ['id' => $branch->id]) }}"
