    ...
    <div class="page-titles">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="javascript:void(0)">Student Notifications</a>
        </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($notification->student_id == null)
                                        <span class="text-warning">All Students</span>
                                    @else
                                        <span class="text-warning">{{$notification->student->name}}</span>
                                    @endif
                                </td>
                        ...
                        @if ($notifications)
                            ...
                            @foreach ($notifications as $notification)
                                <tr>
                                    ...
                                    <td> {{$notification->branch->branch_name}} </td>
                                    <td>{{$notification->title}}</td>
                                    <td>{{$notification->message}}</td>
                                    <td>{{$notification->created_at->diffForHumans()}}</td>
    ...
    <div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
      ...
      <div class="offcanvas-body">
          <div class="container-fluid">
              ...
              <form action="{{route('send_student_notification')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-xl-12 mb-3">
                        <label for="student_id" class="form-label">Notification To<span class="text-danger">*</span></label>
