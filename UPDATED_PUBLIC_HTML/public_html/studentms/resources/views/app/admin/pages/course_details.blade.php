            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('payment_details', ['id' => $studentData->id]) }}" class="nav-link ">Payment
                                Details</a>
                        </li>
                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <div class="profile-personal-info">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-9 col-7">
                                            @if ($studentData->batch)
                                                <span><b> Batch " {{ $studentData->batch->batch_name }}
                                                        "</b> &nbsp; - &nbsp;
                                                    {{ $studentData->batch->batch_time }}</span>
                                            @else
                                                <p class="text-danger">* Batch not found</p>
                                            @endif
                                        ...
                                        <div class="col-sm-9 col-7">
                                            <span>
                                                @if ($studentData->batch)
                                                    ...
                                                    @else
                                                        <p class="text-danger">* Batch faculty not found</p>
                                                    @endif
                                                @else
                                                    <p class="text-danger">* Batch not found</p>
                                                @endif
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500">Legal Document Link <span class="pull-end">:</span>
                                            </h5>
                                        </div>
                                        <div class="col-sm-9 col-7">
                                            <a class="text-red" href="{{ $studentData->profile }}"
                                                target="_blank"><u>{{ $studentData->profile }}</u></a>
                                        </div>
                                    </div>
