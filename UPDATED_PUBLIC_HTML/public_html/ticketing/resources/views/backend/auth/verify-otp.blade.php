                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <h5 class="card-title text-center pb-0 fs-4">Enter OTP to Login</h5>
                                    </div>
                                    <div id="otp-timer" class="text-danger text-center mb-2"
                                        style="font-size: 12px !important;">
                                        OTP expires in <span id="timer">10:00</span> seconds
                                    </div>
                                    <form method="POST" action="{{ route('otp.verify.submit') }}" class="row g-3">
                                        @csrf
                                        <div class="mb-3">
                                            {{-- <label for="otp" class="form-label">OTP</label> --}}
                                            <input type="text" name="otp" class="form-control" required>
                                        </div>
                                        <button type="submit" id="verify-btn" class="btn btn-primary">Verify
                                            OTP</button>
                                    </form>
