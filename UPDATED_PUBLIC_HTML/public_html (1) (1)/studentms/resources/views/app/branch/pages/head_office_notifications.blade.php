    ...
    <div class="page-titles">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="javascript:void(0)">Heade Office Notifications</a>
        </li>
    ...
    <div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
      ...
      <div class="offcanvas-body">
          <div class="container-fluid">
              ...
              <form action="{{route('send_msg_to_admin')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                      ...
                      <input type="hidden" name="subject" value="toAdmin">
                  </div>
                  <div>
