                                ...
                                <div class="info-list">
                                    <ul>
                                        ...
                                        <li><a href="javascript:void(0);">Admission
                                                Date</a><span>{{ \Carbon\Carbon::createFromFormat('Y-d-m', $studentData->admission_date)->format('F j, Y') }}</span></li>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card profile-card card-bx m-b30">
                        ...
                        <form class="profile-form"
                            action="{{ route('branch_update_students', ['id' => $studentData->id]) }}" method="POST"
